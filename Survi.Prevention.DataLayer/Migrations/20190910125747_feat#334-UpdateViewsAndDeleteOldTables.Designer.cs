...
namespace Survi.Prevention.DataLayer.Migrations
{
    ...
    [Migration("20190910125747_feat#334-UpdateViewsAndDeleteOldTables")]
    partial class feat334UpdateViewsAndDeleteOldTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Survi.Prevention.Models.InspectionManagement.Batch", b =>
                {
                    b.HasOne("Survi.Prevention.Models.Security.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("IdWebuserCreatedBy")
                        .HasConstraintName("fk_batch_users_created_by_id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Survi.Prevention.Models.InspectionManagement.BatchUser", b =>
                {
                    ...
                    b.HasOne("Survi.Prevention.Models.Security.User", "User")
                        .WithMany()
                        .HasForeignKey("IdWebuser")
                        .HasConstraintName("fk_batch_user_users_user_id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Survi.Prevention.Models.InspectionManagement.Inspection", b =>
                {
                    ...
                    b.HasOne("Survi.Prevention.Models.Security.User", "AssignedTo")
                        .WithMany()
                        .HasForeignKey("IdWebuserAssignedTo")
                        .HasConstraintName("fk_inspection_users_assigned_to_id");

                    b.HasOne("Survi.Prevention.Models.Security.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("IdWebuserCreatedBy")
                        .HasConstraintName("fk_inspection_users_created_by_id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Survi.Prevention.Models.InspectionManagement.InspectionVisit", b =>
                {
                    ...
                    b.HasOne("Survi.Prevention.Models.Security.User", "VisitedBy")
                        .WithMany()
                        .HasForeignKey("IdWebuserVisitedBy")
                        .HasConstraintName("fk_inspection_visit_users_visited_by_id");
                });
