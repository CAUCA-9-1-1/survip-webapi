...
namespace Survi.Prevention.DataLayer.InitialData
{
    public static class InitialDataForBaseTable
    {
	    ...
	    {
		    yield return new RateUnitOfMeasure {Abbreviation = "GIPM", Localizations = new List<UnitOfMeasureLocalization> {new UnitOfMeasureLocalization {Name = "GIPM", LanguageCode = "fr"}, new UnitOfMeasureLocalization {Name = "GIPM", LanguageCode = "en" } }};
		    yield return new RateUnitOfMeasure { Abbreviation = "GPM", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "GPM", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "GPM", LanguageCode = "en" } } };
		    yield return new RateUnitOfMeasure { Abbreviation = "LPM", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "LPM", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "LPM", LanguageCode = "en" } } };
		    yield return new RateUnitOfMeasure { Abbreviation = "GI", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "GI", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "GI", LanguageCode = "en" } } };
		    yield return new RateUnitOfMeasure { Abbreviation = "G", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "G", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "G", LanguageCode = "en" } } };
		    yield return new RateUnitOfMeasure { Abbreviation = "L", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "L", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "L", LanguageCode = "en" } } };
		    yield return new RateUnitOfMeasure { Abbreviation = "", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Indéterminé", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Unknown", LanguageCode = "en" } } };

		    yield return new PressureUnitOfMeasure { Abbreviation = "PSI", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "PSI", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "PSI", LanguageCode = "en" } } };
		    yield return new PressureUnitOfMeasure { Abbreviation = "KPA", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "KPA", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "KPA", LanguageCode = "en" } } };
		    yield return new PressureUnitOfMeasure { Abbreviation = "m3/h", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "m3/h", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "m3/h", LanguageCode = "en" } } };

		    yield return new DiameterUnitOfMeasure { Abbreviation = "mm", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Millimètres", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Millimeters", LanguageCode = "en" } } };
		    yield return new DiameterUnitOfMeasure { Abbreviation = "po", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Pouces", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Inches", LanguageCode = "en" } } };

		    yield return new DimensionUnitOfMeasure { Abbreviation = "m", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Mètres", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Meters", LanguageCode = "en" } } };
		    yield return new DimensionUnitOfMeasure { Abbreviation = "pi", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Pieds", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Feet", LanguageCode = "en" } } };

		    yield return new CapacityUnitOfMeasure { Abbreviation = "m3", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Mètres cubes", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Cubic meters", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "po3", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Pouces cubes", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Cubic inches", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "ml", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Millilitres", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Millilitre", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "pt", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Pintes", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Pints", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "t", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Tonnes", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Tons", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "sh tn", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Tonnes US", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "US tons", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "pi3", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Pieds cubes", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Cubic feet", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "GI", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Gallons impériaux", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Imperial gallons", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Aucune", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "None", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "G", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Gallons US", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "US gallons", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "g", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Grammes", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Grams", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "Kg", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Kilos", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Kilos", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "L", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Litres", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Litres", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "lb", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Livres", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Pounds", LanguageCode = "en" } } };
		    yield return new CapacityUnitOfMeasure { Abbreviation = "oz", Localizations = new List<UnitOfMeasureLocalization> { new UnitOfMeasureLocalization { Name = "Onces", LanguageCode = "fr" }, new UnitOfMeasureLocalization { Name = "Onces", LanguageCode = "en" } } };
		}
    }
}
