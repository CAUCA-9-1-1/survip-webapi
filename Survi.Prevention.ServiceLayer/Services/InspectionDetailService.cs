		...
		private InspectionBuildingDetailForWeb GetDetailForStartedInspection(Guid inspectionId, string languageCode)
		{
			var query =
				...
				select new
				{
                    ...
                    MainBuildingCorporateName = building.CorporateName,
            ...
            return new InspectionBuildingDetailForWeb
            {
                ...
                MainBuildingAliasName = result.MainBuildingName,
                MainBuildingCorporateName = result.MainBuildingCorporateName,
