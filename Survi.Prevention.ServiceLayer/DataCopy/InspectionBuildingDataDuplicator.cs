...
namespace Survi.Prevention.ServiceLayer.DataCopy
{
	public class InspectionBuildingDataCopyManager : IDisposable
	{
		...
		private void ReplaceBuildingWithCopy()
		{
			...
			new OriginalBuildingReplacer(context, inspectionId)
	...
	public class OriginalBuildingReplacer
	{
		...
		public OriginalBuildingReplacer(ManagementContext context, Guid inspectionId)
		{
			this.context = context;
			this.inspectionId = inspectionId;
		}
		...
		private static void ReplaceAnomalies(InspectionBuilding copy, Building building)
		{
		...
		private static void ReplaceAnomalyPictures(InspectionBuildingAnomaly copy, BuildingAnomaly anomaly)
		{
		...
		private static Picture ReplacePicture(InspectionPicture copy, Picture original)
		{
		...
		private static Picture CreatePicture(InspectionPicture copy)
		{
			return new Picture
			{
				Id = copy.Id,
		...
		private static void ReplaceCourses(InspectionBuilding copy, Building building)
		{
		...
		private static void ReplaceCourseLanes(InspectionBuildingCourse copy, BuildingCourse course)
		{
		...
		private static void ReplaceSprinklers(InspectionBuilding copy, Building building)
		{
		...
		private static void ReplacePersonsRequiringAssistance(InspectionBuilding copy, Building building)
		{
		...
		private static void ReplaceParticularRisks(InspectionBuilding copy, Building building)
		{
		...
		private static void ReplaceParticularRiskPictures(InspectionBuildingParticularRisk copy, BuildingParticularRisk risk)
		{
			foreach (var anoPic in copy.Pictures)
			{
		...
		private static BuildingParticularRisk CreateNewRisk(InspectionBuildingParticularRisk copy)
		{
		...
		private static void ReplaceLocalizations(InspectionBuilding copy, Building building)
		{
		...
		private static void ReplaceHazardousMaterials(InspectionBuilding copy, Building building)
		{
		...
		private static void ReplaceFireHydrants(InspectionBuilding copy, Building building)
		{
		...
		private static void ReplaceContacts(InspectionBuilding copy, Building building)
		{
		...
		private static void ReplaceAlarmPanel(InspectionBuilding copy, Building building)
		{
